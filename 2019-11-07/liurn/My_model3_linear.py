...
class My_model(nn.Module):
    def __init__(self, fsdh_input_dim, fsdh_hidden_1, fsdh_hidden_2, fsdh_out_dim, batch_size, layers, beta=2.0,
        ...
        #     self.add_module('layers_'+i,nn.Sequential(nn.Linear(fsdh_input_dim,fsdh_out_dim), nn.BatchNorm1d(fsdh_out_dim), nn.ReLU()))
        ...
        self.layer_init = nn.Sequential(nn.Linear(fsdh_input_dim, fsdh_out_dim), nn.BatchNorm1d(fsdh_out_dim))  # nn.BatchNorm1d(fsdh_out_dim)
