...
checkpoint_num = 0
need_train = True
model_saved_path = "../res_mat_cpu/my_model"+str(num)+"_layers"+str(layers)+"_nbits"+str(fsdh_out_dim)+"_lr"+str(learning_rate)+"_epoch"+str(epoch_num)+".pt"
...
class My_model(nn.Module):
    def __init__(self, fsdh_input_dim, fsdh_hidden_1, fsdh_hidden_2, fsdh_out_dim, batch_size, layers, beta=2.0, gamma=1e-3,
        ...
        self.layer_init = nn.Sequential(nn.Linear(fsdh_input_dim,fsdh_out_dim),nn.BatchNorm1d(fsdh_out_dim), nn.Tanh())
